...
**What is {}**
curly brackets are used to 1. group numbers 2. define the arguments for previously stated commands. The order also matters since \frac{1}{2} is 1 over 2 and \frac{2}{1} is 2 over 1. Generally the first argument is on top and the second argument will be on the bottom
